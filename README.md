...
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?color=0E75B6&size=24&center=true&vCenter=true&width=750&duration=3000&pause=1000&lines=Machine+Learning+Engineer;AI+Developer;Zoho+Cliqtrix'26;Round+1+Shortlisted+–+Top+35+Teams;200%2B+DSA+Problems+Solved;Building+Scalable+Intelligent+Systems" />
</p>
...
- Real-time task creation & dashboard access  
- Focus Hub with Pomodoro tracking  
- Automated reminders & productivity reports  
- Built for Zoho Cliqtrix'26 Bot Building Contest  

---

## 🔹 CNN-Based Road Condition Classification  
🔗 https://github.com/Rakshitha20045/Road_Condition_Classification  

- CNN model for multi-class road condition detection  
- Achieved **70% accuracy** (due to limited dataset quality)  
- Used OpenCV preprocessing & augmentation  
